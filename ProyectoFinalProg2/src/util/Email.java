...
public class Email {
	 ...
	 *             if the connection is dead or not in the connected state or if the
	 *             message is not a MimeMessage
	 */
	public void SendEmail(final String username, final String password, String recipientEmail, String title,
